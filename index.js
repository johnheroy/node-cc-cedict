...
var cnchars = require('cn-chars'); // convert between traditional and simplified
var path = require('path');
var pinyin = require('prettify-pinyin'); // prettify the pinyin default (letters + numbers) in CC-CEDICT
